"use strict";
(self["webpackChunkreact_hello_webapp"] = self["webpackChunkreact_hello_webapp"] || []).push([[974],{
...
/* harmony default export */ const isURLSameOrigin = (platform/* default */.A.hasStandardBrowserEnv ? ((origin, isMSIE) => (url) => {
  url = new URL(url, platform/* default */.A.origin);
  ...
  new URL(platform/* default */.A.origin),
  platform/* default */.A.navigator && /(msie|trident)/i.test(platform/* default */.A.navigator.userAgent)
) : () => true);
...
/* harmony default export */ const resolveConfig = ((config) => {
  ...
  newConfig.url = (0,buildURL/* default */.A)((0,buildFullPath/* default */.A)(newConfig.baseURL, newConfig.url, newConfig.allowAbsoluteUrls), config.params, config.paramsSerializer);
