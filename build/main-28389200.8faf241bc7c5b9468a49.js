...
@media (max-width: 576px) {
  ...
  .cart .row > .col-md-7 {
    order: 1; /* Show product list first */
    margin-bottom: 15px;
  }

  .cart .row > .col-md-5 {
    order: 2; /* Show summary second */
  }

  .cart .card {
    height: auto; /* Ensure cards adjust height dynamically */
  }
}
...
.buy-now-button, .add-cart-details-button {
  width: 100%;
  padding: 12px;
  font-size: 16px;
  border-radius: 6px;
